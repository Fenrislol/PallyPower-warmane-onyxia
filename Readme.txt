Customized version for 3.3.5a server
Added blessing of light & blessing of salvation which are not in the client 3.3.5 (because expansion 2.4.3).

bug with xml tables (11 classes instead of 9) I don't have the energy to fix it and to pick on xml in general - so if you want to fix it - bang a pr or a fork.


=====================================================
Original readme and addon info from the creators below
=====================================================
